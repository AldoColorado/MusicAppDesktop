...
namespace FEiMusic.Model
{
        ...
        public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(List<ListaReproduccion> cuenta = default(List<ListaReproduccion>))
        {
            this.Cuenta = cuenta;
        }
        ...
        /// Gets or Sets Cuenta
        /// </summary>
        [DataMember(Name="cuenta", EmitDefaultValue=false)]
        public List<ListaReproduccion> Cuenta { get; set; }
        ...
        public bool Equals(InlineResponse2003 input)
        {
            ...
            return 
                (
                    this.Cuenta == input.Cuenta ||
                    this.Cuenta != null &&
                    input.Cuenta != null &&
                    this.Cuenta.SequenceEqual(input.Cuenta)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                int hashCode = 41;
                if (this.Cuenta != null)
                    hashCode = hashCode * 59 + this.Cuenta.GetHashCode();
                return hashCode;
            }
        }
