...
namespace FEiMusic.Model
{
        ...
        public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="artistlike">artistlike.</param>
        public InlineResponse2007(List<ArtistLikeResponse> artistlike = default(List<ArtistLikeResponse>))
        {
            this.Artistlike = artistlike;
        }
        
        /// <summary>
        /// Gets or Sets Artistlike
        /// </summary>
        [DataMember(Name="artistlike", EmitDefaultValue=false)]
        public List<ArtistLikeResponse> Artistlike { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Artistlike: ").Append(Artistlike).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2007 input)
        {
            ...
            return 
                (
                    this.Artistlike == input.Artistlike ||
                    this.Artistlike != null &&
                    input.Artistlike != null &&
                    this.Artistlike.SequenceEqual(input.Artistlike)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.Artistlike != null)
                    hashCode = hashCode * 59 + this.Artistlike.GetHashCode();
                return hashCode;
            }
        }
