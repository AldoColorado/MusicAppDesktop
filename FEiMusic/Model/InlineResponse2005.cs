...
namespace FEiMusic.Model
{
        ...
        public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="songlike">songlike.</param>
        public InlineResponse2005(List<SongLikeResponse> songlike = default(List<SongLikeResponse>))
        {
            this.Songlike = songlike;
        }
        
        /// <summary>
        /// Gets or Sets Songlike
        /// </summary>
        [DataMember(Name="songlike", EmitDefaultValue=false)]
        public List<SongLikeResponse> Songlike { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Songlike: ").Append(Songlike).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2005 input)
        {
            ...
            return 
                (
                    this.Songlike == input.Songlike ||
                    this.Songlike != null &&
                    input.Songlike != null &&
                    this.Songlike.SequenceEqual(input.Songlike)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.Songlike != null)
                    hashCode = hashCode * 59 + this.Songlike.GetHashCode();
                return hashCode;
            }
        }
