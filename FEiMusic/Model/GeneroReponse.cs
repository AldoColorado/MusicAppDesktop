...
namespace FEiMusic.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GeneroReponse :  IEquatable<GeneroReponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneroReponse" /> class.
        /// </summary>
        /// <param name="idGenero">idGenero.</param>
        /// <param name="nombre">nombre.</param>
        public GeneroReponse(string idGenero = default(string), string nombre = default(string))
        {
        ...
        {
            return this.Equals(input as GeneroReponse);
        }

        /// <summary>
        /// Returns true if GeneroReponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneroReponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneroReponse input)
        {
            if (input == null)
                return false;
