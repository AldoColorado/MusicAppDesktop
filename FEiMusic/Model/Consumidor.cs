...
namespace FEiMusic.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Consumidor :  IEquatable<Consumidor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Consumidor" /> class.
        /// </summary>
        /// <param name="idConsumidor">idConsumidor.</param>
        /// <param name="nombre">nombre.</param>
        /// <param name="apellidos">apellidos.</param>
        /// <param name="username">username.</param>
        public Consumidor(string idConsumidor = default(string), string nombre = default(string), string apellidos = default(string), string username = default(string))
        {
        ...
        {
            return this.Equals(input as Consumidor);
        }

        /// <summary>
        /// Returns true if Consumidor instances are equal
        /// </summary>
        /// <param name="input">Instance of Consumidor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Consumidor input)
        {
            if (input == null)
                return false;
